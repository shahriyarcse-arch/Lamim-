...
if (!window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    ...
    animate('.hero h1', { opacity: [0, 1], transform: ['translateY(30px)', 'translateY(0)'] }, { duration: 0.6, delay: 0.02, easing: ease });
    animate('.hero h1 em', { opacity: [0, 1], transform: ['scale(0.88)', 'scale(1)'] }, { duration: 0.5, delay: 0.2, easing: ease }).finished.then(() => {
        document.querySelector('.hero h1 em').style.transform = '';
        document.querySelector('.hero h1 em').style.opacity = '';
    });
    animate('.hero p', { opacity: [0, 1], transform: ['translateY(20px)', 'translateY(0)'] }, { duration: 0.5, delay: 0.12, easing: ease });
    const heroBtns = document.querySelectorAll('.hero .actions .btn');
    heroBtns.forEach((el, i) => {
        animate(el, { opacity: [0, 1], transform: ['translateY(14px)', 'translateY(0)'] }, { duration: 0.4, delay: 0.25 + i * 0.1, easing: ease }).finished.then(() => {
            el.style.transform = '';
        });
    });
