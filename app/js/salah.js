...
const Salah = {
  ...
  statusMeta: {
    ...
    qaza:   { label: 'Qaza',    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><g style="transform-origin: center"><animateTransform attributeName="transform" type="scale" values="1; 1.06; 1" dur="3s" repeatCount="indefinite"/><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></g></svg>', color: '#d29922', bgAlpha: 'rgba(210,153,34,0.12)', borderAlpha: 'rgba(210,153,34,0.4)', desc: 'Made up later', result: 'qaza',       points: 3, glow: '0 0 12px rgba(210,153,34,0.6)' },
